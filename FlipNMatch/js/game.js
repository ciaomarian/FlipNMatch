(() => {
    ...
    class Card {
        ...
        <div class="card-front">
          <img src="images/flip-flops.svg" class="card-image" >
        </div>
      </div>`;
        }
    }
    ...
    // number of cards in deck array by level
    ...
    const makeCardArray = (data, level) => {
        ...
        // Get the correct deck array for level
        let trimmedData = trimArray(data, level);

        // Add two of each card to the deck array
